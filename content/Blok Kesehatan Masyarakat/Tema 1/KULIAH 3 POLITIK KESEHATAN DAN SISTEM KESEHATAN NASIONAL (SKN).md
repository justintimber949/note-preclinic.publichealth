# POLITIK KESEHATAN DAN SISTEM KESEHATAN NASIONAL (SKN)
```
POLITIK KESEHATAN DAN SISTEM KESEHATAN NASIONAL (SKN)
...
│   │   │   └───(Tabel Sektor dan Kontribusi)
│   │   └───D. ESENSI ADVOKASI DAN KOLABORASI
│   │       ├───Meningkatkan Pengaruh dalam Pengambilan Kebijakan
│   │       ├───Pemberdayaan Masyarakat
│   │       ├───Kolaborasi untuk Keberhasilan Kesehatan
...
└───📚 BAGIAN II: SISTEM KESEHATAN NASIONAL (SKN)
    ...
    │   └───Keputusan Menteri Kesehatan RI Nomor 131/MENKES/SK/II/2004
    ├───🏗️ Konsep Dasar SKN
    │   └───Pembangunan Kesehatan
    ├───📖 Definisi SKN
    │   └───(Definisi SKN)
    ├───🎯 Hakikat SKN
    │   ├───Wujud metode penyelenggaraan pembangunan kesehatan
    │   ├───Memadukan berbagai upaya dalam satu derap langkah
    │   └───Guna menjamin tercapainya tujuan pembangunan kesehatan
    ├───⚖️ Landasan SKN
    │   ├───Landasan Idiil: PANCASILA
    │   ├───Landasan Konstitusional: UUD 1945
    │   └───Landasan Operasional: UU No. 36 Tahun 2009 tentang Kesehatan
    ├───🎯 Tujuan SKN
    ...
    │   ├───SECONDARY HEALTH CARE (Pelayanan Kesehatan Lanjutan)
    │   └───TERTIARY HEALTH CARE (Pelayanan Kesehatan Unggulan)
    └───🔧 SUBSISTEM SKN
...
SKN terdiri dari **7 SUBSISTEM** yang saling terkait:
...
##### **Dua Fungsi Utama Dinkes Kab/Kota:**
...
Penggunaan dana kesehatan untuk:
...
Pengelolaan penyelenggaraan berbagai upaya kesehatan, baik perorangan, kelompok, maupun masyarakat secara **terencana, terpadu, dan berkesinambungan** guna tercapainya derajat kesehatan masyarakat yang setinggi-tingginya.
