...
---
```
KULIAH 10: MANAJEMEN MUTU PELAYANAN KESEHATAN
├─── Learning Objectives
│    ├─── Memahami Pengertian Manajemen Mutu
│    ├─── Memahami Konsep PDCA (Plan-Do-Check-Act)
│    ├─── Memahami SPM (Standar Pelayanan Minimal)
│    ├─── Memahami Audit Internal
│    ├─── Memahami RTM (Rapat Tinjauan Manajemen)
│    ├─── Memahami Kualitas Pelayanan
│    └─── Memahami Kepuasan Pelanggan/Pasien
├─── 1. PENGERTIAN MUTU
...
│    └─── Definisi: Aktivitas Manajemen dalam Bentuk
│         ├─── Quality Planning
│         ├─── Quality Control
│         ├─── Quality Assurance
│         ├─── Quality Improvement
...
│         │    ├─── Dapatkan Baseline Data
│         │    └─── Rumuskan Langkah Koreksi
│         ├─── 2. DO (Pelaksanaan)
│         │    ├─── Laksanakan Rencana Perbaikan
│         │    └─── Upayakan Perbaikan/Peningkatan
│         ├─── 3. CHECK/STUDY (Evaluasi)
│         │    ├─── Pelajari Efek Perubahan
│         │    ├─── Kumpulkan Data Baru
│         │    ├─── Lihat Efek Perubahan
│         │    └─── Replikasikan Jika Berhasil
│         └─── 4. ACT (Tindak Lanjut)
│              ├─── Jika Berhasil: Standarisasikan
│              └─── Jika Kurang Berhasil: Cari Jalan Lain
...
│              ├─── Pembilang/Penyebut
│              ├─── Standar/Satuan Pencapaian Kinerja
│              └─── Sumber Data
├─── 10. AUDIT INTERNAL
│    ├─── Pengertian Audit
...
│         ├─── Paham dan Mampu Menerapkan Prosedur Audit
...
│         ├─── Hasil Pertemuan Ditindaklanjuti
│         └─── Tindak Lanjut Dipantau Pelaksanaannya
│    └─── INPUT RTM (Masukan)
│         ├─── Tindak Lanjut RTM yang Lalu
│         ├─── Hasil Audit Internal
│         ├─── Hasil Implementasi Mutu Teknis
│         ├─── Umpan Balik Pelanggan/PKPKP
│         ├─── Kinerja Proses
...
│         └─── Penyediaan Sumber Daya yang Perlu Dilakukan Agar Sistem Pelayanan Efektif
│    └─── Alur RTM
...
│    └─── Glosarium
└─── 22. KESIMPULAN
     ├─── Take Home Messages: Untuk Ujian
     └─── Take Home Messages: Untuk Praktik
```
## 📋 Learning Objectives
