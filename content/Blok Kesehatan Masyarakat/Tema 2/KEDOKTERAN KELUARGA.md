...
KEDOKTERAN KELUARGA
├─── Pendahuluan
│    └─── Definisi: Pelayanan kesehatan tingkat pertama, komprehensif, berkesinambungan, fokus pada individu, keluarga, dan komunitas
├─── Sejarah dan Perkembangan Kedokteran Keluarga (Dipersingkat)
...
│    │    ├─── Deteksi Dini Penyakit Berulang
│    │    └─── Follow-up Setelah Rawat Inap/Rujukan
│    ├─── 3. Koordinasi dan Kolaborasi (Coordination of Care)
│    │    ├─── Koordinator Utama Pelayanan
│    │    ├─── Mengatur Rujukan
...
│    │    └─── Mengenal Latar Belakang Budaya dan Gaya Hidup
│    ├─── 5. Berorientasi Keluarga dan Komunitas
│    │    ├─── Keluarga Sebagai Unit Kesehatan
│    │    │    └─── Sistem Pendukung Utama
│    │    └─── Kesehatan Komunitas
│    │         ├─── Posyandu
│    │         ├─── Penyuluhan Gizi
│    │         └─── Vaksinasi
│    ├─── 6. Pelayanan Berbasis Ilmu Kedokteran dan Bukti (Evidence-Based Practice)
│    │    ├─── Pendekatan Ilmiah dan Data
│    │    └─── Memanfaatkan Clinical Practice Guidelines
│    └─── 7. Efisiensi dan Keadilan
│         ├─── Penggunaan Sumber Daya Efisien
│         └─── Adil Bagi Semua Lapisan Masyarakat
├─── Karakteristik Pelayanan Dokter Keluarga (WONCA dan IDI)
...
│    ├─── 1. Kasus Hipertensi dalam Keluarga
│    │    ├─── Skrining Tekanan Darah
│    │    ├─── Edukasi Diet dan Aktivitas Fisik
│    │    ├─── Jadwal Kunjungan Berkala
│    │    └─── Rujukan Jika Ada Komplikasi
│    ├─── 2. Kasus Gizi Buruk Anak
│    │    ├─── Menilai Berat Badan dan Pola Asuh
│    │    └─── Melibatkan Bidan, Kader Posyandu, Penyuluh Gizi
│    └─── 3. Kasus Kesehatan Mental Ringan (Anxiety)
│         ├─── Menilai Stresor
│         ├─── Konseling Dasar dan Dukungan Keluarga
│         └─── Rujukan ke Psikolog Bila Perlu
├─── Prinsip Etika dalam Kedokteran Keluarga
│    ├─── 1. Autonomy (Otonomi)
│    ├─── 2. Beneficence (Kebajikan)
...
- Dokter keluarga memantau perkembangan pasien secara jangka panjang.
