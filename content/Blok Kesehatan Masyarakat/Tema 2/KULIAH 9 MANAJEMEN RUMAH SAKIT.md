...
---
```
KULIAH 9: MANAJEMEN RUMAH SAKIT
├─── LEARNING OUTCOMES
│    ├─── Memahami Pengertian, Jenis, Persyaratan, dan Struktur Organisasi Klinik
│    ├─── Memahami Definisi, Jenis, Fungsi, dan Struktur Organisasi Rumah Sakit
│    ├─── Memahami Perbedaan Klinik dan RS
│    ├─── Memahami Faktor yang Mempengaruhi Penggunaan RS
│    ├─── Memahami Utilitas RS
│    └─── Memahami Peraturan-peraturan terkait RS
...
│    └─── Fungsi Rumah Sakit (4 Fungsi Utama)
...
│    │    └─── Karakteristik (Didirikan Permanen)
│    ├─── 2. Rumah Sakit Bergerak / RS Lapangan
│    │    └─── Karakteristik (Siap Guna, Sementara)
│    └─── 3. Rumah Sakit Lapangan (di Lokasi Tertentu)
│         └─── Karakteristik (Didirikan di Lokasi Tertentu, Sementara)
├─── BAB 4: KLASIFIKASI RUMAH SAKIT
│    ├─── Dasar Klasifikasi (4 Aspek Utama)
...
│    │    ├─── EKSISTING (Sebelumnya): Izin Mendirikan, Izin Operasional
│    │    └─── KEDEPAN (Sekarang): Perizinan Berusaha (terintegrasi dalam sistem OSS)
│    └─── Tujuan Reformasi
│         ├─── Kemudahan Akses Pelayanan Kesehatan Kepada Masyarakat
│         ├─── Kemudahan Pelaku Usaha dalam Menyediakan Pelayanan Kesehatan
│         └─── Kemudahan Pekerja/Tenaga Kesehatan
...
│    └─── Rumah Sakit Khusus
│         ├─── Pelayanan Medik dan Penunjang Medik Sesuai Kekhususan
│         ├─── Pelayanan Keperawatan dan/atau Kebidanan
│         ├─── Pelayanan Kefarmasian
│         └─── Pelayanan Penunjang Lainnya
├─── BAB 7: FASILITAS KESEHATAN DAN SARANA PENUNJANG
│    ├─── 1. Bangunan dan Prasarana
│    │    ├─── Persyaratan Keandalan Teknis Bangunan Gedung dan Konstruksi
...
│         ├─── SDM Diangkat dan Ditetapkan oleh Kepala/Direktur RS
│         ├─── Pemilik RS dan Kepala/Direktur RS Bertanggung Jawab dalam Pemenuhan SDM
│         ├─── RS Dapat Mempekerjakan Tenaga Tidak Tetap dan/atau Tenaga Lainnya
│         └─── SDM Disesuaikan untuk Setiap Kelas RS
├─── BAB 9: PERUBAHAN KELAS RUMAH SAKIT
│    ├─── Dasar Perubahan Kelas RS
│    │    ├─── Usulan dari Pemilik atau Kepala/Direktur RS
│    │    └─── Hasil Pengawasan oleh Pemerintah Pusat/Pemda
│    └─── Syarat dan Ketentuan
│         ├─── Usulan Perubahan Kelas Hanya Dapat Dilakukan Terhadap RS yang Telah Terakreditasi
│         ├─── Perubahan Kelas Dilakukan dengan Menilai Pemenuhan
│         └─── Perubahan Kelas Ditindaklanjuti dengan
├─── BAB 10: KEWAJIBAN RUMAH SAKIT (20 Kewajiban)
...
│    └─── 20. Memberlakukan Seluruh Lingkungan RS sebagai Kawasan Tanpa Rokok
...
3. **Sarana Penunjang**
    ...
    - Laboratorium, radiologi, farmasi, dll.
...
> **Catatan Penting:** RS Kelas D hanya untuk daerah khusus. Tidak boleh dibangun di daerah perkotaan yang sudah memiliki akses RS memadai.
...
> **Pengecualian:** Tidak berlaku untuk RS Khusus Gigi dan Mulut, Mata, dan THT-KL
...
1. **Merupakan tenaga tetap yang bekerja secara purna waktu**
...
- Wajib melayani pasien gawat darurat 24/7
...
- Membentuk **Tim Panel** yang bersifat ad hoc
...
- Memberikan pertimbangan teknis medis kepada direktur
...
> **Catatan:** Struktur organisasi dapat berbeda-beda tergantung kelas dan jenis RS, tetapi elemen minimal harus ada.
...
Atau: **Rata-rata hari sebuah TT kosong** dari saat terisi ke saat terisi berikutnya.
...
**Interpretasi:** NDR 15 per 1000 → BAIK (< 25 per 1000).
...
Jika pasien keluar **setelah jam sensus**, maka HP = LD.
...
- Layanan: dokter umum, dokter gigi
...
- Mengatur penyelenggaraan RS secara umum
- Klasifikasi RS
- Perizinan
...
**Tentang:** Persyaratan Teknis Rumah Sakit
...
> **Catatan:** RS yang terakreditasi Paripurna menunjukkan RS tersebut memiliki sistem manajemen mutu yang baik dan pelayanan yang berkualitas tinggi.
...
1. **Mengapa RS Kelas D hanya boleh dibangun di daerah tertentu?**
    ...
    - Untuk menjamin akses minimal di daerah terpencil
